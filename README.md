...
<span style="color:#ff6700">function</span> <span style="color:#0f4c5c">getProfileInfo</span>() {
  <span style="color:#153243">return</span> {
    <span style="color:#ff206e">greeting</span>: "<span style="color:#8d0801">Hi there!</span>",
    <span style="color:#ff206e">about</span>: "<span style="color:#7f5539">I’m passionate about crafting web experiences where design, logic, and user needs come together seamlessly.</span>",
    
    <span style="color:#ff206e">highlights</span>: [
      "<span style='color:#153243'>Frontend-focused developer with fullstack capabilities</span>",
      "<span style='color:#153243'>Strong interest in Product Management & Quality Assurance (QA)</span>",
      "<span style='color:#153243'>Problem-solver who loves turning ideas into real-world products</span>",
      "<span style='color:#153243'>Always learning, improving, and exploring new technologies</span>"
    ],

    <span style="color:#ff206e">education</span>: {
      <span style="color:#FF5733">degree</span>: "<span style='color:#153243'>CSE Graduate Student</span>",
      <span style="color:#FF5733">institute</span>: "<span style='color:#153243'>American International University of Bangladesh</span>"
    }
  };
}
</pre>
...
✔️ Attention to detail from a **QA mindset**  
...
<img src="https://media.giphy.com/media/L95W4wv8nnb9K/giphy.gif" width="550" />
</td>
...
**"Building not just code, but experiences."**
<br>
